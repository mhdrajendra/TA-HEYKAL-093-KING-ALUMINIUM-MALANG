...
export default function MaterialKeluarPage() {
  ...
  const handleSubmit = (
    ...
    if (
      ...
      setMessage(
        `Stok tidak mencukupi. Stok ${selectedMaterial.name} saat ini hanya ${selectedMaterial.stock} ${selectedMaterial.unit}.`
      );
      return;
    }
    ...
    setMessage(
      `Transaksi berhasil disimpan. ${selectedMaterial.name} berkurang ${quantityNumber} ${selectedMaterial.unit}.`
    );
      ...
      <div className="page-main">
        ...
        <main className="page-content">
          ...
          <div className="transaction-heading">
            ...
            <p>
              Pencatatan Transaksi Stok Material
              Keluar.
            </p>
          </div>
                ...
                <div className="transaction-form-grid">
                  <div className="transaction-form-left">
                    ...
                    <div className="transaction-actions">
                      <button
                        type="submit"
                        className="transaction-out-button"
                      >
                        Simpan Transaksi
                      </button>
                  ...
                  <div className="transaction-preview">
                    ...
                    <div className="estimated-stock-card outgoing">
                      <strong>
                        {estimatedStock >= 0
                          ? estimatedStock
                          : 0}
